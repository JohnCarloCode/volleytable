...
import { useElementSize, useIdFactory } from './hooks.js'
import {
  clamp01,
  courtAspect,
  displayPos,
...
export default function BoardView({ board, update }) {
  ...
  const handleMove = useCallback(
    ...
    [orientation, view], // eslint-disable-line react-hooks/exhaustive-deps
  )
  ...
  const benchDragEnd = useCallback(
    ...
    [getCourtRect, benchColAt, view, orientation], // eslint-disable-line react-hooks/exhaustive-deps
  )
